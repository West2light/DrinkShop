                ...
                <div className="container mx-auto px-4 py-6 lg:py-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex space-x-2 overflow-x-auto">
                                {[product.image, product.image, product.image, product.image].map((image, index) => (
                                    <button
                                        key={index}
                                        className={`w-16 h-16 lg:w-20 lg:h-20 border-2 rounded-lg overflow-hidden flex-shrink-0 ${index === 0 ? "border-yellow-500" : "border-gray-200"
                                            }`}
                                    >
                                        <Image
                        ...
                        <div className="space-y-4 lg:space-y-6">
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 mb-4 space-y-2 sm:space-y-0">
                                    <div className="flex items-center">
                                        {[...Array(5)].map((_, i) => (
                                            <span
                                                key={i}
                                                className={`text-yellow-500 text-base lg:text-lg ${i < product.rating ? "" : "text-gray-300"}`}
                                            >
                                                ★
                                            </span>
                                        ))}
                                    ...
                                    <span className="text-sm text-gray-500">| Thêm đánh giá của bạn</span>
                                </div>
                                <div className="flex items-center space-x-4 mb-4 lg:mb-6">
                                    <span className="text-2xl lg:text-3xl font-bold text-yellow-600">{product.price}</span>
                                    <span className="text-base lg:text-lg">đ</span>
                                    {product.originalPrice && (
                                        <span className="text-base lg:text-lg text-gray-500 line-through">{product.originalPrice}đ</span>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
                                        ...
                                        <Button className="w-full sm:w-auto bg-black text-white hover:bg-gray-800 px-6 py-3">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4 pt-4 border-t">
                                ...
                                <div className="flex space-x-2">
                                    ...
                                    <Button size="sm" className="bg-blue-400 hover:bg-blue-500 text-xs">
                                        Twitter
                                    </Button>
                        ...
                        <TabsContent value="description" className="mt-6">
                            <div className="prose max-w-none">
                                <p className="text-gray-700 leading-relaxed mb-4 text-sm lg:text-base">
                                    Dòng sản phẩm rượu vang đỏ này được sản xuất từ những cây nho tốt nhất, qua quá trình lên men tự nhiên
                                    và ủ trong thùng gỗ sồi cao cấp. Sản phẩm có màu đỏ ruby đậm đà, hương thơm phức hợp của các loại trái
                                    cây chín mọng và gia vị tinh tế.
                                </p>
                                <p className="text-gray-700 leading-relaxed mb-4 text-sm lg:text-base">
                                    Vị rượu cân bằng giữa độ chua và độ ngọt tự nhiên, với hậu vị kéo dài và đầy ấn tượng. Thích hợp
                                    thưởng thức cùng các món thịt đỏ, phô mai hoặc chocolate đen.
                                </p>
                                    ...
                                    <table className="w-full text-sm">
                                        <tbody className="space-y-2">
                                            ...
                                            <tr className="border-b">
                                                ...
                                                <td className="py-2">{product.features[0]?.split(": ")[1] || "Không xác định"}</td>
                                            </tr>
                                            <tr className="border-b">
                                            ...
                                            <tr className="border-b">
                                                ...
                                                <td className="py-2">{product.features[1]?.split(": ")[1] || "13.5%"}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div className="border-b pb-4">
                                        ...
                                        <p className="text-gray-700 text-sm lg:text-base">
                                            Sản phẩm rất tốt, hương vị đậm đà và thơm ngon. Giao hàng nhanh chóng và đóng gói cẩn thận.
                                        </p>
                                    </div>
                    ...
                    <div>
                        <div className="text-center mb-6 lg:mb-8">
                            <h2 className="text-xl lg:text-2xl font-bold mb-4">SẢN PHẨM LIÊN QUAN</h2>
                            <Image
