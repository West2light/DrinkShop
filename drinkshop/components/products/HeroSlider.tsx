...
export default function HeroSlider() {
    ...
    if (loading) {
        return (
            <div className="relative w-screen -mx-4 sm:-mx-6 lg:-mx-8 xl:-mx-16 2xl:-mx-72">
    ...
    if (error) {
        return (
            <div className="relative w-screen -mx-4 sm:-mx-6 lg:-mx-8 xl:-mx-16 2xl:-mx-72">
                <div className="relative w-full h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[80vh] bg-gray-100 flex items-center justify-center">
    ...
    return (
        <div className="relative w-screen -mx-4 sm:-mx-6 lg:-mx-8 xl:-mx-16 2xl:-mx-72">
            ...
            >
                ...
                {/* Shadcn Navigation Arrows - Customized */}
                <CarouselPrevious
                    className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 backdrop-blur-sm border-none h-10 w-10 md:h-12 md:w-12 text-white hover:text-white z-30"
                />

                <CarouselNext
                    className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 backdrop-blur-sm border-none h-10 w-10 md:h-12 md:w-12 text-white hover:text-white z-30"
                />
